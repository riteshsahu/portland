...
import {SelectedJob} from '../../views/ActiveJobs/reducer/action.activeJobs';
...
class AppSlideBar extends Component {
  constructor(props) {
    super(props);
    ...
    if(createCustomerUrl && createCustomerUrl.indexOf('createCustomer') > -1 ){
      ...
      if(r == true){ 
       localStorage.setItem('urlPath',"");
        ...
        this.props.history.push("/customer/createCustomer");
       }
    }else{
     // this.props.history.push("/customer/createCustomer");
      return ;
...
AppSlideBar.propTypes = propTypes;
AppSlideBar.defaultProps = defaultProps;
...
function mapDispatchToProps(dispatch) {
  return {
    SelectedJob:(value)=> dispatch(SelectedJob(value))
  };
}
