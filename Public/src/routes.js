...
// const Gics = React.lazy(() => import ('./views/Gics/gics'));
// const Search = React.lazy(() => import('./views/Persons/persons')); 
// const Form = React.lazy(() => import('./views/Intake Form/intake')); 
// const AgentForm= React.lazy(() => import('./views/Agent Form/agent'));
// const Request = React.lazy(() => import('./views/UserManagement/Request/Request'));
// const UserGroup = React.lazy(() => import('./views/UserManagement/UserGroup/UserGroup'));
...
const routes = [
  ...
  // { path: '/userManagement', exact: true, name: 'User Management', component: Request },
  // { path: '/userManagement/request',  name: 'Request', component: Request },
  // { path: '/userManagement/userGroup',  name: 'User Group', component: UserGroup },
  // { path: '/userManagement/userMapping',  name: 'User Mapping', component: UserMapping },
  // {path: '/intakeform', name: 'Intake Form', component: Form},
  // {path: '/agentform', name: 'Agent Form', component: AgentForm},
  // {path: '/gic',  exact: true, name: 'GIC', component: Search},
  // {path: '/gic/persons', name: 'Persons', component: Search},
  // {path: '/gic/gics', name: 'GICS', component: Gics},
